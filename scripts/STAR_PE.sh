...
# Usamos parallel para lanzar 3 muestras a la vez, dándole 10 hilos a cada STAR = 30 hilos
parallel -j 3 "
    ...
    STAR --runThreadN 10 \\
         ...
         --readFilesIn $INPUT_DIR/{}_clean_1.fastq.gz $INPUT_DIR/{}_clean_2.fastq.gz \\
...
echo "Alineamiento PE completado."